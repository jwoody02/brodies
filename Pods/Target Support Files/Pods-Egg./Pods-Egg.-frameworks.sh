...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DPTagTextView/DPTagTextView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ISPageControl/ISPageControl.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/loady/Loady.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/nanopb/nanopb.framework"
fi
if [[ "$CONFIGURATION" == "Debug M1" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ActiveLabel/ActiveLabel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireImage/AlamofireImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppAuth/AppAuth.framework"
