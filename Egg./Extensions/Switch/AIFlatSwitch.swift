...
//  Egg.
//
//  Created by Jordan Wood on 8/15/22.
//
...
@IBDesignable open class AIFlatSwitch: UIControl {
     ...
     */
    @IBInspectable open var strokeColor: UIColor = Constants.primaryColor.hexToUiColor() {
        didSet {
     ...
     */
    @IBInspectable open var trailStrokeColor: UIColor = Constants.secondaryColor.hexToUiColor() {
        didSet {
