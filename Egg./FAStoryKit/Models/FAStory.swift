...
final public class FAStory: NSObject, FAStoryTeller, Decodable {
    ...
    /// last seen story id + timestamp
    public var lastSeenStoryID: String
    public var lastSeenStoryTimeStamp: Double
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case contentNature
        case ident
        case lastSeenStoryID
        case lastSeenStoryTimeStamp
    ...
    public init(from decoder: Decoder) throws {
        ...
        lastSeenStoryID = try values.decode(String.self, forKey: .lastSeenStoryID)
        lastSeenStoryTimeStamp = try values.decode(Double.self, forKey: .lastSeenStoryTimeStamp)
        self.ident = ident
    ...
    public init(with content: FAStoryAddible, name: String, builtIn flag: Bool = true, preview image: UIImage? = nil, ident: String, lastSeenID: String, lastSeenTimeStamp: Double) {
        self.name = name
        self.content = [content]
        self.contentNature = flag ? .builtIn : .online
        self.ident = ident
        self.lastSeenStoryID = lastSeenID
        self.lastSeenStoryTimeStamp = lastSeenTimeStamp
        //
        super.init()
        //
    }
